<template>
  <div class="q-my-xl">
    ...
    >
      <div class="text-weight-bold q-mt-xl">Flavors</div>
      <q-splitter
      ...
      />
      <div class="q-mb-xl text-h6">Sips and Dishes</div>
    </div>
...
const images = [
  '/img/flavors/image (11).png',
  '/img/flavors/image (12).png',
  '/img/flavors/image (13).png',
  '/img/flavors/image (14).png',
  '/img/flavors/image (15).png',
  '/img/flavors/image (25).png',
]
