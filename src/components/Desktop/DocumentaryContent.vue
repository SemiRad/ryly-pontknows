<template>
  <div class="q-my-xl">
    ...
    >
      <div class="text-weight-bold q-mt-xl">documentaries</div>
      <q-splitter
      ...
      />
      <div class="q-mb-xl text-h6">event chronicles</div>
    </div>
...
const images = [
  '/img/documentaries/image (26).png',
  '/img/documentaries/image (27).png',
  '/img/documentaries/image (28).png',
  '/img/documentaries/image (29).png',
  '/img/documentaries/image (30).png',
  '/img/documentaries/image (31).png',
]
